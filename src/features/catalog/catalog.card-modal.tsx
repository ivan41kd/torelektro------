									...
									return (
										...
										>
											<>
												...
												<span className='product__card-variant-name'>
													с мощностью
												</span>
											</>
										</button>
							...
							<div className='product__card-img-wrapper'>
								...
								<div className='product__img-stickers'>
									<div className='product__img-stickers-items'>
										{Object.entries(
											products[number].variants[tab].options[0],
										).map(([key, val]) => {
											if (key === 'length') {
												return (
													<div
							...
							<div className='product__card-info'>
								<div className='product__card-info-wrapper'>
									...
									<div className='product__card-options'>
										{products[number].variants[tab].options.map(
											(item, index) => {
												return (
													<div
								...
								<p className='product__disclaimer'>
									вся информация о товарах и об услугах, носит исключительно
