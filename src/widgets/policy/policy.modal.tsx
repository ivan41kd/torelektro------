				...
				<div className='political__wrapper'>
					...
					<div className='political__text-wrapper'>
						<p className='political__text'>
							...
							своей деятельности соблюдение прав и свобод человека <br /> при
							...
							быть получена оператором о посетителях интернет-сайта: 
							<span>
								<OptimizedLink href='https://torelektro.ru'>
									https://torelektro.ru
								</OptimizedLink>
							</span>{' '}
							(далее - сайт). <br />
							...
							данных, а также определяющие цели обработки и состав персональных
							...
							прав субъектов персональных данных по запросу органа;
							<br />
							...
							данных в соответствии с российским законодательством;
							...
							являются неполными, устаревшими, неточными, незаконно полученными и
							не являются необходимыми для заявленной цели обработки;
							<br /> — направлять требования о прекращении обработки персональных
							данных;
							...
							конкретных, заранее определенных и законных целей. <br />
						...
						<p className='political__text'>
							...
							по которому станет выгодоприобретателем. <br />
							...
							договором, стороной которого, приобретателем по которому является
							субъект персональных данных. <br />
							8.3. Оператор не отвечает за действия третьих лиц. <br />
							8.4. Вся информация, которая собирается сторонними сервисами, в том
							числе платежными системами, средствами связи и другими поставщиками
							услуг, хранится и обрабатывается указанным лицам (оператором)
							в соответствии с политикой конфиденциальности. <br />
							...
							10. Трансграничная передача персональных данных <br /> Оператор
							до начала осуществления деятельности по трансграничной передаче
							...
							<span>
								<OptimizedLink href='mailto:tor@torelektro.ru'>
									tor@torelektro.ru
								</OptimizedLink>
							</span>
							. <br />
